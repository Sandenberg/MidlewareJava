...
public class OrderRowNode {
    ...
    public OrderRowNode(int id, int productId, int productAttributeId, int productQuantity, String productName, String productReference, double unitPriceTaxIncl) {
        this.id = id;
