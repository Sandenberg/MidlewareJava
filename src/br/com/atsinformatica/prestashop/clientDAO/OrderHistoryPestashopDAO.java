...
public class OrderHistoryPestashopDAO extends GenericPrestashopDAO<OrderHistory> implements IGenericPrestashopDAO<OrderHistory>{
    ...
    public void post(String path, OrderHistory t) {
        ...
        ClientResponse response = getWebResource().path(path).queryParam("sendemail", "1").type(MediaType.APPLICATION_XML).post(ClientResponse.class, xml);

    }

    @Override
    public int put(String path, OrderHistory t) {
