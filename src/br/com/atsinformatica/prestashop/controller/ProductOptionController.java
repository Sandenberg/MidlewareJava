...
public class ProductOptionController {
    ...
    public int updateProductOptionPrestashop(AtributoGradeEcom atributo){
        ProductOptionDAO dao = new ProductOptionDAO();
        return dao.put(ProductOption.URLPRODUCTOPTIONS, createProductOption(atributo));
    }
    
    public int deleteProductOption(String id){
        ProductOptionDAO dao = new ProductOptionDAO();
        return dao.delete(ProductOption.URLPRODUCTOPTIONS, id);
    }
