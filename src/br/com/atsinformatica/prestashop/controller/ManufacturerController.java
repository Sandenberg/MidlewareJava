...
public class ManufacturerController  {
    ...
    public int createManufacturerPrestashop(CadFabricERPBean cadFab){
        return new ManufacturerDAO().postManuf(Manufacturer.URLMANUFACTURERS, createManufacturer(cadFab));
    }
     ...
     * @param cadFab fabricante do erp
     */
    public int updateManufacturerPrestashop(CadFabricERPBean cadFab){
        return new ManufacturerDAO().put(Manufacturer.URLMANUFACTURERS, createManufacturer(cadFab));
    }
     ...
     */
    public int deleteManufacturerPrestashop(String id){
        return new ManufacturerDAO().delete(Manufacturer.URLMANUFACTURERS, id);
    }
    /**
