...
public class ConfirmacaoEntrega extends javax.swing.JDialog {
    private static Logger logger = Logger.getLogger(ConfirmacaoEntrega.class);
    ...
    public ConfirmacaoEntrega(java.awt.Frame parent, boolean modal, String codPedidoResulth, Integer codPedidoEcom) {
        super(parent, modal);
        initComponents();
...
//    #OldStatusChange
//    public void statusEntregue(Integer codPedidoEcom, String codPedidoResulth, String numDocumetoEntrega) {
...
//                    orderController.updateStatusOrder(Integer.valueOf(codPedidoEcom), StatusPedido.ENTREGUE);
...
//                    historyController.insertOrderHistory(Integer.valueOf(codPedidoEcom), StatusPedido.ENTREGUE);
