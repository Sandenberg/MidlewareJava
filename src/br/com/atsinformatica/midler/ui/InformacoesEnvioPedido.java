...
public class InformacoesEnvioPedido extends javax.swing.JDialog {
    private static Logger logger = Logger.getLogger(InformacoesEnvioPedido.class);
    ...
    public InformacoesEnvioPedido(java.awt.Frame parent, boolean modal, String codPedidoResulth, Integer codPedidoEcom) {
        super(parent, modal);
        initComponents();
...
//    #OldStatusChange
//    public void statusEnviado(Integer codPedidoEcom, String codPedidoResulth, String codRastreiamento, Date dataEnvioPedidoEcom) {
...
//            listaPedidoERPBean.setCodPedidoResulth(codPedidoResulth);
...
//                    orderController.updateStatusOrder(Integer.valueOf(codPedidoEcom), StatusPedido.ENVIADO, codRastreiamento);
...
//                    historyController.insertOrderHistory(Integer.valueOf(codPedidoEcom), StatusPedido.ENVIADO);
