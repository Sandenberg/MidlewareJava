...
//    }
    ...
    public static void reiniciaAplicacao() {
        String comando = "java -jar " + new File("").getAbsolutePath() + "\\Modulo_Integrador.jar";
...
//---------------------------------------------------------------------------------------------//
    ...
    public static String retornaNomePagamento(String descPagamento){
        if(descPagamento!=null){
            String str = descPagamento.replaceAll(" ", "");
            switch (str.toLowerCase()) {
                case "bankwire":
                    return "Transferência Bancária".toUpperCase();
                case "cashondelivery":
                    return "Pagamento na entrega".toUpperCase();
                case "pagseguro":
                    return "PagSeguro".toUpperCase();
                case "paypal":
                    return "PayPal".toUpperCase();
                case "cielo":
                    return "Cielo".toUpperCase();
                case "cheque":
                    return "Cheque".toUpperCase();
                default:
                    throw new UnsupportedOperationException("Forma de pagamento desconhecido");
            }
        }
        return "";
    }
