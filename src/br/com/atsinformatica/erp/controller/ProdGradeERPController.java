...
public class ProdGradeERPController {
    ...
    public int atualizaEstoque(ProdutoERPBean prodBean){
        ...
        try{            
            ...
            if(p!=null){
                ...
                if(prodBean.getGrade()!=0){
                    //grade comum ou simples
                    if(prodBean.getGrade()==1 || prodBean.getGrade() == 2)listaGrades = prodGradeDAO.searchGradeComumByCodProd(prodBean.getCodProd());
                    //grade composta
                    if(prodBean.getGrade()==3)listaGrades = prodGradeDAO.searchGradeCompostaByCodProd(prodBean.getCodProd());                        
            ...
            //codigo de atualização realizada com sucesso
            return 200;
        }catch(Exception e){
            Logger.getLogger(ProdGradeERPController.class).error("Erro ao atualizar estoque: "+e);
            //erro ao realizar atualização de estoque
            return 500;
